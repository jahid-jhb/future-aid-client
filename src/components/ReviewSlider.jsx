...
const ReviewSlider = ({ scholarshipId }) => {
    ...
    return (
        <div className="w-full max-w-3xl mx-auto my-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center text-accent">What Our Students Say</h2>
            <Swiper
                    ...
                    <SwiperSlide key={review._id}>
                        <div className="card bg-base-100 shadow-xl border border-blue-100 mx-2">
                            <div className="card-body items-center text-center">
                                ...
                                <h4 className="font-bold text-lg text-accent">{review.reviewerName}</h4>
